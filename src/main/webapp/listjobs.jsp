...
<body>
    ...
    <div class="container">
        ...
        <div class="header-container">
            <h1>All Jobs</h1>
            <a href="${pageContext.request.contextPath}/companydropdown" class="add-button">Add Job</a>
        </div>
                ...
                <c:forEach var="job" items="${jobs}">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="${pageContext.request.contextPath}/viewJob/${job.id}" class="view-button">View</a>
                            <a href="${pageContext.request.contextPath}/updateJob/${job.id}" class="update-button">Update</a>
                            <a href="${pageContext.request.contextPath}/deleteJob/${job.id}" class="delete-button">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
